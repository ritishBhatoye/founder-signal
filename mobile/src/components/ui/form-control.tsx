...
export const FormControl = React.forwardRef<React.ElementRef<typeof View>, FormControlProps>(
...
>(({ className, ...props }, ref) => {
  return <View ref={ref} className={formControlLabelStyle({ className })} {...props} />;
});
...
>(({ className, ...props }, ref) => {
  return <Text ref={ref} className={formControlLabelTextStyle({ className })} {...props} />;
});
...
export const FormControlLabelAstrick = React.forwardRef<
  ...
  TextProps & { className?: string }
>(({ className, ...props }, ref) => {
  return <Text ref={ref} className={formControlLabelAstrickStyle({ className })} {...props} />;
});
...
export const FormControlError = React.forwardRef<
  ...
  ViewProps & { className?: string }
>(({ className, ...props }, ref) => {
  return <View ref={ref} className={formControlErrorStyle({ className })} {...props} />;
});
...
export const FormControlErrorText = React.forwardRef<
  ...
  TextProps & { className?: string }
>(({ className, ...props }, ref) => {
  return <Text ref={ref} className={formControlErrorTextStyle({ className })} {...props} />;
});
