    ...
    >
      <View>
        <InputGroup
          placeholder="Name"
          label="Full Name"
          startContent={<Ionicons name="person-outline" size={20} color="#6B7280" />}
        ...
        <InputGroup
          label="Phone"
          placeholder="91 *********"
          startContent={<Ionicons name="call-outline" size={20} color="#6B7280" />}
      ...
      <View className="mb-6 flex-row items-start gap-3">
        ...
        <View className="flex-1">
          ...
          <Text className="text-sm text-primary-400">I accept the terms</Text>
        </View>
      </View>
