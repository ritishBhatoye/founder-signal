            ...
            <ThemedView className="m-2 gap-4 rounded-xl bg-white p-4 dark:bg-primary-800/10">
              ...
              <CalendarInput
                ...
                onChange={(date: string) =>
                  formik.setFieldValue("basicInfo.dob", date)
                }
              ...
              <View className="mt-4">
                ...
                <View className="flex-col items-start gap-4 space-x-6 pt-2">
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      formik.setFieldValue("basicInfo.status", "ACTIVE")
                    }
                  >
                                       {" "}
                  ...
                  <TouchableOpacity
                    className="flex-row items-center"
                    onPress={() =>
                      formik.setFieldValue("basicInfo.status", "INACTIVE")
                    }
                  >
                                       {" "}
                    <View className="h-5 w-5 items-center justify-center rounded-full border border-gray-500">
              ...
              <View className="mt-6 flex-col items-start gap-2">
                ...
                <CheckboxGroup
                  ...
                  value={
                    formik.values.basicInfo.insuranceDetail.individual ?? false
                  }
                  onChange={(checked: boolean) =>
                    formik.setFieldValue(
                      "basicInfo.insuranceDetail.individual",
                      checked
                    )
                  }
                  touched={
                    formik.touched.basicInfo?.insuranceDetail?.individual
                  }
                ...
                <CheckboxGroup
                  ...
                  onChange={(checked: boolean) =>
                    formik.setFieldValue(
                      "basicInfo.insuranceDetail.group",
                      checked
                    )
                  }
                ...
                {formik.errors.basicInfo?.insuranceDetail &&
                  typeof formik.errors.basicInfo.insuranceDetail ===
                    "string" && (
      ...
      <View className="w-full flex-row justify-between gap-x-3 bg-white px-5 pb-8 pt-5">
        ...
        <View className="w-auto flex-1">
          ...
          <Button
            ...
            onPress={() =>
              router.push(
                "/(drawer-routes)/hr/employee-lifecycle/add-new-employee/exit"
              )
            }
          />
                 {" "}
