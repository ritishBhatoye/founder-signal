...
export const mockAlerts: Alert[] = [
  {
    ...
    description:
      "Payment failed for customer@example.com ($49/mo). Retry scheduled.",
  ...
  },
  {
    ...
    description:
      "MRR dropped 5% compared to last week. 2 cancellations detected.",
    timestamp: "Yesterday",
    isRead: false,
  },
  {
    ...
    title: "Churn Warning",
    description:
      "3 customers cancelled in the last 48 hours. Above normal rate.",
  ...
  },
  {
    ...
    description:
      "Previously failed payment for user@company.com was recovered.",
